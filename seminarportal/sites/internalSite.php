...
if (!$user || !$user->email) {
    ...
    die('Bitte zuerst einloggen: <a href="internalLogin.php">User</a>  <a href="internal.php">Interal User</a>');
}
...
<head>
	<title>Home Internal User</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div id="navbar">
		<ul>
		  <li><a class="active" href="internalSite.php">Home Internal User</a></li>
