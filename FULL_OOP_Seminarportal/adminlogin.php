...
if (isset($_POST['userlogin'])) {
	$answer = $database_connection->LoginUser($_POST,true);
	if ($answer['success'] == true) {
		$user = $answer['user'];
		$_SESSION['USER'] = new User($user[0],$user[1],$user[2],$user[3],$user[4]);
	};
	$adminlogin_error = $answer['message'];
}

$database_connection->CheckValidLogin(true,true,"index.php");
